...
def combine(automata1:SubgoalAutomaton,automata2:SubgoalAutomaton):
...
if __name__ == "__main__":
    ...
    dfa2.add_edge("u0", "uA", ["f", "g"])
    dfa2.add_edge("u0", "uR", ["n", "~f", "~g"])
    dfa2.add_edge("u1", "uA", ["g"])
    dfa2.add_edge("u1", "uR", ["n", "~g"])
    dfa2.add_edge("u1", "u2", ["1"])
